...
static const R_CMethodDef cMethods[] =
{
   ...
   {"Divide",     (DL_FUNC) &Divide,   6, argDivide},
   {NULL, NULL, 0, NULL}
};
...
R_CallMethodDef callMethods[] =
{
	...
	{ "FlugbahnV3",   (DL_FUNC)&FlugbahnV2,  6 },
	{ NULL, NULL, 0 }
};
...
SEXP FlugbahnV3 (SEXP v0, SEXP t ,SEXP angle_Schussebenen, SEXP Ziel_Schussebenen,SEXP m, SEXP k)
{
  ...
  double* p_vx = (double *)R_alloc(iter, sizeof(double));
  double*p_vy = (double *)R_alloc(iter, sizeof(double));
  double* p_sx = (double*)R_alloc(iter, sizeof(double));
  double* p_sy = (double*)R_alloc(iter, sizeof(double));
  double* p_t = (double*)R_alloc(iter, sizeof(double));
